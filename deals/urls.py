...
#     FollowUserView, UnfollowUserView,UserLoginAPIView,UserLogoutAPIView,RegisterAPIView,CommentCreateView, CommentUpdateDeleteView
# )
...
#     path('', DealListCreateView.as_view(), name='deal_list'),
...
#     path('api/comments/', CommentCreateView.as_view(), name='create_comment'),
#     path('api/comments/<int:pk>/', CommentUpdateDeleteView.as_view(), name='edit_delete_comment'),
# ]
...
from .views import (
    ...
    UserLoginAPIView, UserLogoutAPIView, RegisterAPIView,
